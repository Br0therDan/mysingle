      ...
      <div className=" max-w-6xl text-left my-0 mx-auto px-4">
        <div className=" p-7 rounded-2xl bg-gray-100">
          ...
          <p className=" mt-6">
            ...
            MySingle. These Terms apply to all users of the
          ...
          <p className=" mt-6">
            ...
            by MySingle and are protected by copyright,
          ...
          <p className=" mt-6">
            ...
            our Services. By doing so, you grant MySingle a
          ...
          <p className="mt-6">
            To the fullest extent permitted by law, MySingle
          ...
          <p className="mt-6">
            ...
            MySingle and its officers, directors, employees,
          ...
          <p className=" mt-6">
            ...
            contact us at contact@MySingle. By using our
